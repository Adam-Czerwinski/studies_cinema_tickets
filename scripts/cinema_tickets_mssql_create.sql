...
ALTER TABLE [clients_movies_halls] CHECK CONSTRAINT [clients_movies_halls_fk0]
GO
ALTER TABLE [clients_movies_halls] WITH CHECK ADD CONSTRAINT [clients_movies_halls_fk1] FOREIGN KEY ([id_movie]) REFERENCES [movies]([id])
ON UPDATE CASCADE
GO
ALTER TABLE [clients_movies_halls] CHECK CONSTRAINT [clients_movies_halls_fk1]
GO
ALTER TABLE [clients_movies_halls] WITH CHECK ADD CONSTRAINT [clients_movies_halls_fk2] FOREIGN KEY ([id_hall]) REFERENCES [halls]([id])
ON UPDATE CASCADE
GO
ALTER TABLE [clients_movies_halls] CHECK CONSTRAINT [clients_movies_halls_fk2]
GO
